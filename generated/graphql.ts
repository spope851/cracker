...
export type FeatureFlagsQuery = { __typename?: 'Query', featureFlags: Array<{ __typename?: 'FeatureFlag', id: string, name: string, description: string, isEnabled: boolean, requiredRole?: number | null }> };
