...
insert into feature_flags ( name, description, is_enabled, required_role ) values ( 'adminDashboardMenuItem', 'option in user menu that navigates to admin dashboard', CAST(0 as BIT), 3 );
