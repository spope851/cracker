-- FUNCTION: public.get_dashboard_counts(integer, character varying, integer[], numeric, numeric)

-- DROP FUNCTION IF EXISTS public.get_dashboard_counts(integer, character varying, integer[], numeric, numeric);
...
ALTER FUNCTION public.get_dashboard_counts(integer, character varying, integer[], numeric, numeric)
    OWNER TO postgres;
